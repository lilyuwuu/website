# Preface A: What is Competitive Karaoke?
...
But, of course, this also means that competitive karaoke requires a bit more effort than a karaoke video to make. Unlike a video, where the only thing you have to focus on is sentence timing (and it doesn't even have to be all that accurate) competitive karaoke requires that you time each individual note correctly *and* ensure that each note has the correct pitch -- otherwise players will be frustrated by a low quality chart, just like they would for any other rhythm game.
...
* [UltraStar Deluxe](https://usdx.eu/)
    + [My Little Karaoke](https://www.mylittlekaraoke.com/): While branded as a 'separate' game, it is actually effectively a song pack and theme for UltraStar Deluxe. *You can run My Little Karaoke's theme and song pack on a newer installation of UltraStar Deluxe by copying over the song, theme, and avatar folders, with some modifications*
* [UltraStar Play](https://github.com/UltraStar-Deluxe/Play) / [Melody Mania](https://melodymania.org/en)
...
* [Tune Perfect](https://tuneperfect.org/)
* [UltraStar WorldParty](https://ultrastar-es.org/en)
...
* Support is also possibly *eventually* planned for the multi-rhythm game engines [YARG](https://yarg.in/) and [Project OutFox](https://projectoutfox.com/)
...
[>> Continue to Preface B: The UltraStar Format and Editors](../prefaceB){ .md-button}
